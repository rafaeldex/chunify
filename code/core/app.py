...
def update_user(user_id):
  user_as_json = app.current_request.json_body
  return get_database('users').update_user(user_id, user_as_json)
...
# Observes the DynamoDBStream
@app.on_dynamodb_record(stream_arn=music_stream_arn, batch_size=100, starting_position='LATEST', name=None, maximum_batching_window_in_seconds=0)
